...
class Window:
    ...
    def __init__(
        ...
        self.edge_lower = 1 + self.margins[1] # Not sure why this needs to be 1 by default, but I'll figure that out later
        self.edge_left = 0 + self.margins[2]
        self.edge_right = 0 + self.margins[3]
    ...
    def print(self):
        """
        Print the window and its contents (widgets) to the terminal's screen
        """
        # Attributes
